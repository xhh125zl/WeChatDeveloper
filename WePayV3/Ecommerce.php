...
class Ecommerce extends BasicWePay
{
     ...
     * @deprecated 自己加的，建议使用ecommerceApplyments
     */
     ...
     * @deprecated 自己加的，建议使用ecommerceApplymentsByApplymentId
     */
     ...
     * @throws \WeChat\Exceptions\InvalidResponseException
     * @document https://pay.weixin.qq.com/wiki/doc/apiv3_partner/apis/chapter7_1_2.shtml
     * @deprecated 自己加的，建议使用ecommerceApplymentsByRequestNo
     */
     ...
     * @deprecated 自己加的，建议使用mediaUpload
     */
